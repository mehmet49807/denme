...
CREATE TABLE IF NOT EXISTS staff (
  ...
  role ENUM('admin','cashier','waiter','kitchen','bar') NOT NULL,
  pin VARCHAR(12) NULL,
...
CREATE TABLE IF NOT EXISTS orders (
  ...
  kitchen_slip_sent_at DATETIME NULL DEFAULT NULL,
  bar_slip_sent_at DATETIME NULL DEFAULT NULL,
  kitchen_slip_acked_at DATETIME NULL DEFAULT NULL,
  bar_slip_acked_at DATETIME NULL DEFAULT NULL,
