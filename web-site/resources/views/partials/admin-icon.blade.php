@switch($icon ?? '')
    ...
    @case('flag')
        ...
        @break
    @case('crown')
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"><path d="M2 19h20"/><path d="M4 19V9l4 3 4-6 4 6 4-3v10"/></svg>
        @break
    @case('broadcast')
    ...
    @case('logout')
        ...
        @break
    @case('sparkles')
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"><path d="M12 3l1.9 5.8L20 11l-6.1 2.2L12 19l-1.9-5.8L4 11l6.1-2.2L12 3z"/><path d="M5 3v4M3 5h4M19 17v4M17 19h4"/></svg>
        @break
    @case('chart')
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"><path d="M3 3v18h18"/><path d="M7 14l4-4 4 4 5-8"/></svg>
        @break
    @case('gift')
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"><rect x="3" y="8" width="18" height="13" rx="2"/><path d="M12 8v13"/><path d="M3 12h18"/><path d="M12 8c-2-2.5-4-3-6-1s0 4 2 4h4"/><path d="M12 8c2-2.5 4-3 6-1s0 4-2 4h-4"/></svg>
        @break
    @case('headset')
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"><path d="M4 14v-3a8 8 0 0 1 16 0v3"/><rect x="2" y="14" width="5" height="6" rx="2"/><rect x="17" y="14" width="5" height="6" rx="2"/></svg>
        @break
    @case('refresh')
