@php
    ...
    $initialPanel = $initialPanel ?? old('settings_panel', session('settings_panel', 'menu'));
...
<nav class="profile-settings-menu" data-settings-panel="menu" @if($initialPanel !== 'menu') hidden @endif>
...
<section class="profile-settings-panel" data-settings-panel="edit" @if($initialPanel !== 'edit') hidden @endif>
...
<section class="profile-settings-panel" data-settings-panel="hobbies" @if($initialPanel !== 'hobbies') hidden @endif>
    <form method="POST" action="{{ route('profile.update') }}" class="profile-settings-form">
        @csrf
        @method('PUT')
...
<section class="profile-settings-panel" data-settings-panel="language" @if($initialPanel !== 'language') hidden @endif>
...
<section class="profile-settings-panel" data-settings-panel="password" @if($initialPanel !== 'password') hidden @endif>
