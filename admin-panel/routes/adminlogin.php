...
Route::middleware(['auth', 'admin'])->group(function () {
    ...
    Route::get('/rapor', [AdminRaporController::class, 'index'])->name('admin.rapor');
    Route::post('/rapor/generate', [AdminRaporController::class, 'generate'])->name('admin.rapor.generate');
    Route::get('/rapor/{rapor}', [AdminRaporController::class, 'show'])->name('admin.rapor.show');
