...
class StoryService
{
    ...
    public function createForUser(User $user, string $mediaUrl, string $mediaType, ?string $audience = null): Story
    {
        ...
        if ($audience !== null && in_array($audience, Story::AUDIENCES, true)) {
